...
public class TestConfig implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    Order o1 = new Order(null, Instant.parse("2025-01-12T19:44:41Z"), u1);
    Order o2 = new Order(null, Instant.parse("2025-01-01T08:10:00Z"), u2);
    Order o3 = new Order(null, Instant.parse("2025-01-10T22:02:10Z"), u1);
